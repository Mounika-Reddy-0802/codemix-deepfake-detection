...
| 2026-08-25 | W7-T4 | M | week7-lora-gap-closure | stage-3 lora trained on the rtx 4500: 2154/506 clips, 5 epochs in 2.2 min, best dev eer 1.01%, no collapse (score std 0.478) |
| 2026-08-25 | W7-T4 | M | week7-lora-gap-closure | gap closure measured on the 15 held-out eval speakers: 53.71% -> 1.34% eer, auc 0.459 -> 0.9997, both rows on the same 3,966 clips |
| 2026-08-25 | W7-T4 | M | week7-lora-gap-closure | the failure mode that closed: baseline called 97.4% of genuine hinglish speech spoof, adapted calls 99.9% of it bonafide |
| 2026-08-25 | W7-T4 | M | week7-lora-gap-closure | evaluate.py could not load an adapted checkpoint at all (apply_lora renames q_proj.weight -> q_proj.base.weight); rebuilds the wrapping from the checkpoint's own keys now, 3 tests |
| 2026-08-25 | W7-T4 | M | week7-lora-gap-closure | fixed two manifest bugs that made the run worthless: bonafide deduped on filepath collapsed 1,060 utterances to 10, and nan-truthiness wrote all 1,280 spoof rows to nan.wav |
| 2026-08-25 | W7-T4 | M | week7-lora-gap-closure | adapter scored on the published gap-matrix column too (same 4,434 clips, 25 train-pool speakers): 44.65% -> 1.40% eer, a 32x cut on the paper's own headline row |
| 2026-08-25 | W7-T4 | M | week7-lora-gap-closure | seed variance over 1234/2025/7: 1.45% +- 0.10pp on the held-out pool, 1.47% +- 0.26pp on the gap column, no collapse in any run; seed is not carrying the result |
| 2026-08-25 | W7-T2 | M | week7-lora-gap-closure | BLOCKED on data: english-retention check needs asvspoof 2019 la, which is not staged on the college pc (D:/dfdata has only colab_bundle, lora_bundle, generated, raw/mucs2021) |
| 2026-08-25 | W7-T4 | M | week7-lora-gap-closure | channel_bundle renders a manifest through the verified g711 chain (per-clip noise seed, resumable, 9 tests); render re-verified at 0.185%->0.0001% hf and 18.8 db snr |
| 2026-08-25 | W7-T4 | M | week7-lora-gap-closure | the clean-trained adapter does NOT survive telephony: 1.34% -> 38.58% eer under g711@20db, calling 98.9% of spoofs genuine; its spoof cue was a vocoder signature above 4 khz |
| 2026-08-25 | W7-T4 | M | week7-lora-gap-closure | channel-matched adaptation recovers it: 54.92% -> 3.89% eer on the channel column, costing clean performance (1.34% -> 13.92%); train for the condition you deploy in |
